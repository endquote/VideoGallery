    ...
    return new Vue({
      ...
      watch: {
        ...
        video(newValue) {
          ...
          const state = `${document.location.protocol}//${document.location
            .host}/${tuner}/${channel}/${video}`;
        ...
        nextVideo() {
          ...
          if (unplayed.length === 0) {
            ...
            if (this.videos.length > 1) {
              unplayed = this.videos.filter(
                v => !v.played && v.loaded && v._id !== this.video._id
              );
            } else {
        ...
        "video-info": {
          ...
          computed: {
            ...
            createdDate() {
              ...
              return `${months[
                this.video.created.getMonth()
              ]} ${this.video.created.getDate()}, ${this.video.created.getFullYear()} - `;
            }
          },
          filters: {
            linebreak(value) {
